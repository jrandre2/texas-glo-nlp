    ...
    return {
        ...
        "Key Tables (CSV/JSON)": [
            ...
            Artifact(
                ...
                relpath="outputs/exports/harvey/harvey_action_plan_fund_switch_doc_summary.csv",
                description="Document-level counts of detected fund-switch statements.",
                kind="csv",
            ),
            Artifact(
                label="Harvey fund switch semantic candidates (CSV)",
                relpath="outputs/exports/harvey/harvey_action_plan_fund_switch_semantic_paragraph_candidates.csv",
            ...
            Artifact(
                ...
                relpath="outputs/exports/harvey/harvey_action_plan_fund_switch_semantic_dedup_groups.csv",
            ...
            Artifact(
                ...
                relpath="outputs/exports/harvey/harvey_action_plan_fund_switch_bertopic_topics.csv",
            ...
            Artifact(
                ...
                relpath="outputs/exports/harvey/harvey_action_plan_fund_switch_bertopic_paragraphs.csv",
                description="Paragraph-level topic assignments + confidence for BERTopic (use to review clusters and deduplicate).",
                kind="csv",
            ),
            Artifact(
                label="Harvey fund switch justification timeline (all themes) (CSV)",
                relpath="outputs/exports/harvey/harvey_action_plan_fund_switch_justification_timeline_by_topic.csv",
                description="Quarter-by-quarter theme timeline across BERTopic topics (deduplicated paragraphs).",
                kind="csv",
            ),
            Artifact(
                label="Harvey fund switch relocation justification timeline (CSV)",
                relpath="outputs/exports/harvey/harvey_action_plan_fund_switch_relocation_justification_timeline.csv",
            ...
            Artifact(
                ...
                relpath="outputs/exports/harvey/harvey_housing_quarter_summary.csv",
                description="Quarter-by-quarter summary for all Harvey Housing activities.",
                kind="csv",
            ),
            Artifact(
                label="Harvey housing ZIP × quarter panel (CSV)",
                relpath="outputs/exports/harvey/harvey_housing_zip_quarter_panel.csv",
            ...
            Artifact(
                ...
                relpath="outputs/exports/nlp/money_mentions.csv",
